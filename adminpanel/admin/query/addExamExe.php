...
{
	$insExam = $conn->query("INSERT INTO exam_tbl(cou_id, ex_title, ex_type, ex_time_limit, ex_questlimit_display, ex_description) VALUES('$courseSelected', '$examTitle', '$examType', '$timeLimit', '$examQuestDipLimit', '$examDesc') ");
	if($insExam)
	{
