                    ...
                    ?>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php
                                    if ($selQuestRow['question_type'] == 1)
                                    { 
                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea name="answer[<?php echo $questId; ?>][correct]" id="answer[<?php echo $questId; ?>][correct]" class="form-control" placeholder="Input your answer" autocomplete="off" rows="5" required></textarea>
                                        </div>
                                    </div>
                                    <?php
                                    }
